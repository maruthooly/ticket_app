...
import { dummyShowsData } from '../../assets/asset';
import Loading from '../../components/Loading';
import Title from '../../components/admin/Title';
import { StarIcon , CheckIcon, Delete, DeleteIcon} from 'lucide-react'
import { kConverter } from './kConverter';
...
return nowPlayingMovies.length > 0 ?(
    <>
      ...
      <p className='mt text-lg font-medium'>Now Playing movies</p>
      <div className='overflow-x-auto pb-4'> 
        <div className='group flex flex-wrap gap-4 mt w-max'>
          {nowPlayingMovies.map((movie) => (
            ...
            onClick={() => setSelectedMovie(movie.id)}>
                <div className='relative rounded-l-lg overflow-hidden'>
                  <img src={movie.poster_path} alt=""  className='w-fit object-cover brightness-90'/>
